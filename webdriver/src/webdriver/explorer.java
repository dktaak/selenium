...
public class explorer {
	...
	public static void main(String[] args) throws InterruptedException {
		//instantiate explore browser driver
				System.setProperty("webdriver.ie.driver","C:/Users/Infosys/Downloads/eclipse/IEDriverServer.exe");
				
				//create chrome browser driver
				WebDriver driver = new InternetExplorerDriver();//launches the browser
			    ...
			    Thread.sleep(15000);//provide a delay of 4 second before capture url, so if syatem is slow so login can be successful before capture url
